...
/**
 * UserQuestions form base class.
 *
 * @method UserQuestions getObject() Returns the current form's model object
 *
 * @package    damsharas
 * @subpackage form
 ...
 */
abstract class BaseUserQuestionsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('user_questions[%s]');
